...
#
# EXPECTED REPO LAYOUT (run from anywhere, path is self-locating):
#   CausalVis/
#     data/causal_dataset_v2.pt(.bz2)
#     src/models/pd_gnn.py
#     src/training/train_v2.py   ← this file
#
# WHAT'S NEW VS V1:
...
# ── Self-locating import: works regardless of current working dir ──
ROOT_DIR = os.path.abspath(
    os.path.join(os.path.dirname(__file__), os.pardir, os.pardir))
if ROOT_DIR not in sys.path:
    sys.path.insert(0, ROOT_DIR)

from src.models.pd_gnn import PD_GNN, CausalGNN
...
def main():
    ...
    SAVE_PATH   = os.path.join(ROOT_DIR, 'src', 'models', 'causal_gnn_v2.pt')
    BATCH_SIZE  = 64
    EPOCHS      = 50
    LR          = 0.005
    WD          = 1e-4
