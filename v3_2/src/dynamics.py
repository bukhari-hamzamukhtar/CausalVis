...
class HamiltonianDynamics(nn.Module):
    ...
    def __init__(self, hidden=128, emb=64):
        ...
        # radius is now MEASURED in build_trajectories (Q7), not learned.
        # we keep only a tiny bounded correction on top of the measurement,
        # exactly the way mass works -- starts at the measured value.
    ...
    def properties(self, phys):
        ...
        radius = radius.clamp_min(0.01)                   # starts at the measurement
